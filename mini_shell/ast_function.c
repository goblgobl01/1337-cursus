...
static t_cmd	*create_redirection_node(char *str)
{
	t_redirect	*ptr;
...
static t_cmd	*create_connection_node(char *str)
{
	int i;
	t_cmd *token;
...
static t_cmd	*create_command_node(t_tokens	*token_stream)
{
	t_exec *ptr;
